...
if (len(sys.argv) <= 1):
    fn = "hp3458abx_hp34420a_tcsweep_100mvdc_nplc100_test3_oct2024.dsv"   # Hardcoded filename
else:
...
min_temp = 17                               # Minimum temperature for scale
max_temp = 36                               # Maximum temperature for scale
...
chart6_name = "Reference check of same 1 V signal, µ%s/%s to nominal %g %s" % (stats_units, stats_units, round(ref_val5, 3), stats_units)
...
dataset_name1  =  "HP 3458A (Reference 1) +1 ppm"
dataset_name2  =  "HP 3458B (Reference 2)"
dataset_name3  =  "HP 3459 X9D (Reference 3) -3 ppm"
