...
if (len(sys.argv) <= 1):
    fn = "hp3458abx_hp34420a_tcsweep_1vdc_nplc100_test2_oct2024.dsv"   # Hardcoded filename
else:
...
print ("\033[35;2m-d- Median RAW for val5 = %.9f %s" % (np.median(raw5), stats_units) )
...
ax.legend(ax_legend_labels, loc='upper center')#, dataset_name5, dataset_name6])
ax6.legend(ax6_legend_labels, loc='upper center')#, dataset_name5, dataset_name6])
