...
if (len(sys.argv) <= 1):
    fn = "hp3458abx_hp34420a_tcsweep_k262_102_10mvdc_nplc100_test3_oct2024.dsv"   # Hardcoded filename
else:
...
ax4.text(axis45_x_pos, 0.2,("V23: %9f %s" % (tvalue5, stats_units)), fontsize=12, horizontalalignment='center', verticalalignment='center', transform = ax4.transAxes, bbox=dict(facecolor="#eeeeff", alpha=0.45))
...
ax5.text(axis45_x_pos, 0.2,("V23: %9f %s" % (tvalue6, stats_units)), fontsize=12, horizontalalignment='center', verticalalignment='center', transform = ax5.transAxes, bbox=dict(facecolor="#eeeeff", alpha=0.45))
