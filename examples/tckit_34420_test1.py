...
if (len(sys.argv) <= 1):
    fn = "hp3458abx_hp34420a_tcsweep_10vdc_nplc100_test1_oct2024.dsv"   # Hardcoded filename
else:
...
chart6_name = "Reference check of same 10 V signal, µ%s/%s to nominal 10 %s" % (stats_units, stats_units, stats_units)
...
dataset_name1  =  "HP 3458A (Reference 1)"
